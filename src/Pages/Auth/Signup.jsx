  ...
  return (
    <div
      className={`min-h-screen flex items-center justify-center px-4 transition-all ${
        darkMode ? 'bg-gray-900 relative text-gray-200' : 'bg-white text-black'
      }`}
    >
      <button
        type="button"
      ...
      >
        {darkMode ?  <IoSunny  /> : <BsFillMoonStarsFill  className=' text-gray-800'/>}
      </button>
      ...
      <div className="absolute w-[90%] max-w-[430px] h-[520px]">
        <div
          className={`absolute w-[150px] h-[150px] sm:w-[200px] sm:h-[200px] rounded-full -top-10 -left-10 sm:-top-20 sm:-left-20 ${
            darkMode ? 'bg-gradient-to-br from-purple-700 to-indigo-500' : 'bg-gradient-to-br  from-[#000] to-[#e5ecff]'
          }`}
        ></div>
        <div
          className={`absolute w-[150px] h-[150px] sm:w-[200px] sm:h-[200px] rounded-full -bottom-10 -right-6 sm:-bottom-20 sm:-right-8 ${
            darkMode ? 'bg-gradient-to-r from-purple-700 to-indigo-500' : 'bg-gradient-to-br  to-[#000] from-[#e5ecff]'
          }`}
        ></div>
      </div>
