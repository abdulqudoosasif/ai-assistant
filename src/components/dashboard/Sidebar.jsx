    ...
    <div>
      ...
      <div className="hidden lg:flex w-16 bg-blue-700 rounded-lg m-2 py-4 flex-col items-center h-[98%] justify-between">
        <div className="text-white flex flex-col items-center">
          ...
          <button onClick={handleSetting} className="flex flex-col items-center my-4 text-sm">
      ...
      {isOpen && (
        <div className="lg:hidden top-12 fixed inset-0 bg-blue-500 p-4  w-fit h-fit z-10">
          ...
          <button  onClick={handleSetting} className="flex items-center my-4 gap-4 text-sm text-white">
            <div className="text-2xl"><IoSettings /></div>
            Setting
          </button>
